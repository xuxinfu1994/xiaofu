    ...
    <div>
        <div class="search-bar">
            <van-row  class="test-row">
                <van-col span="3">
                    <img :src="locationIcon" width="80%" class="locationIcon-icon"/>
                </van-col>
                <van-col span="16">
        ...
        <!-- adbanner area -->
        <div>
            <img v-lazy="abBanner" width="100%" />
        </div>
        <!-- Recommend goods area -->
        <div class="reacommend-area">
            <div class="reacommend-title">
                商品推荐
            </div>
            <div class="reacommend-body">
                <swiper :options="swiperOption">
                    <swiper-slide v-for=" (item ,index) in recommendGoods" :key="index">
                        <div class="reacommend-item">
    ...
    export default {
        data() {
            return {
                ...
                msg: 'Shopping Malll',
                locationIcon:require('../../assets/imager/location.png'),
                bannerPicArray:[],
                category:[],
                abBanner:'',
                recommendGoods:[],
        ...
        created(){
            ...
            .then(response=>{
                ...
                if(response.status==200){
                    ...
                    this.abBanner= response.data.data.advertesPicture.PICTURE_ADDRESS
